...
(function() {
    ...
    */
    ...
    function toast(e, n, r) {
        var t = Toast.element;
        var now = new Date();
        Rollbar.info('['+now.toLocaleTimeString()+']'+'<'+n+'>'+e);
        window.console.re.info('['+now.toLocaleTimeString()+']'+'<'+n+'>'+e);
        console.log('['+now.toLocaleTimeString()+']'+'<'+n+'>'+e);
